app.routers.AppRouter = Backbone.Router.extend({
    ...
    menu: function() {
        ...
        app.menu.html(app.menuView.$el);
        if (!app.user._id) {
            app.menuView.withOutUser();
        }
        app.menuView.playClock();
    },
    menutop: function() {
        if (!app.menuTopView) {
        ...
        app.menuTop.html(app.menuTopView.$el);
    },
